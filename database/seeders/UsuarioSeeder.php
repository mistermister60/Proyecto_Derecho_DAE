    ...
    public function run(): void
    {
        ...
        $usuarios = [
            ...
            [
                'rol_id' => $directorId,
                'procurador_id' => null,
                'usuario_nombre' => 'Jose Elias Ramos Ramos',
                'email' => '3180215@usap.edu',
                'contrasena' => Hash::make('password'),
                'usuario_estado' => 'activo',
                'debe_cambiar_contrasena' => true,
            ],
            [
                'rol_id' => $directorId,
                'procurador_id' => null,
                'usuario_nombre' => 'Carlos Amilcar Fuentes Lopez',
                'email' => '1240245@usap.edu',
                'contrasena' => Hash::make('password'),
                'usuario_estado' => 'activo',
                'debe_cambiar_contrasena' => true,
            ],
            [
                'rol_id' => $directorId,
                'procurador_id' => null,
                'usuario_nombre' => 'Jose Gabriel Marves Flores',
                'email' => '1170668@usap.edu',
                'contrasena' => Hash::make('password'),
                'usuario_estado' => 'activo',
                'debe_cambiar_contrasena' => true,
            ],
