    ...
    <div class="flex items-center justify-around h-16 px-2">
        ...
        <div x-data="{ open: false }" class="relative">
            ...
            <div x-show="open" @click.away="open = false"
                ...
                {{-- Botón instalar PWA dentro del menú "Más" (se muestra vía JS en beforeinstallprompt) --}}
                <button id="install-pwa-button-mas" type="button"
                        class="hidden w-full items-center px-4 py-3 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                    <svg class="h-5 w-5 mr-3 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
