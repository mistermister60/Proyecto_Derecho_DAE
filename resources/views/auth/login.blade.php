            ...
            <form method="POST" action="{{ route('login.post') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" required autofocus
                           class="w-full rounded-lg px-3 py-2.5 text-sm outline-none transition-colors border border-gray-200 text-gray-900 bg-white focus:border-blue-600"
                ...
                <div class="mb-5">
                 ...
                 <button type="submit" class="w-full py-2.5 rounded-lg text-sm font-medium transition-all bg-[#1E3A5F] text-white hover:bg-[#16304F]">
                    Entrar
                </button>
            </form>
        </div>
