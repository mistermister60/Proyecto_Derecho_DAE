...
<div x-data="{ 
    ...
    <div class="flex items-center justify-between mb-5">
        ...
        <a href="{{ route('usuarios.create') }}" class="flex items-center gap-1.5 px-4 py-1.5 rounded-lg text-sm font-medium transition-all"
    ...
    <div class="rounded-xl overflow-hidden" style="background: #FFFFFF; border: 1px solid #E5E7EB;">
        <table class="w-full text-sm">
            ...
            <tbody>
                ...
                <tr class="usuario-row transition-colors" style="border-bottom: 1px solid #F3F4F6;"
                    x-show="shouldShow('{{ addslashes($usuario->usuario_nombre) }}', '{{ $usuario->email }}', '{{ $usuario->usuario_estado }}')"
