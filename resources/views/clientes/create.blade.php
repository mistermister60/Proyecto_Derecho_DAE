    ...
    <div class="rounded-xl p-5 mb-4" style="background: #FFFFFF; border: 1px solid #E5E7EB;">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="number" inputmode="numeric" step="1" min="0" name="cliente_dni" value="{{ old('cliente_dni') }}" required placeholder="Ej: 12345678" class="w-full rounded-lg px-3 py-2 text-sm outline-none" style="border: 1px solid #E5E7EB; color: #111827; background: #FFFFFF;" oninput="this.value=this.value.replace(/[^0-9]/g,'');">
                @error('cliente_dni')
                <p class="text-xs mt-1" style="color: #DC2626;">{{ $message }}</p>
                @enderror
            </div>
            <div>
                ...
                <select name="cliente_estado_civil" required class="w-full rounded-lg px-3 py-2 text-sm outline-none" style="border: 1px solid #E5E7EB; color: #111827; background: #FFFFFF;">
                    <option value="" {{ old('cliente_estado_civil') == '' ? 'selected' : '' }}>Seleccionar...</option>
