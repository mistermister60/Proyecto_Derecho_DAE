...
<form action="{{ route('clientes.update', $cliente->cliente_dni) }}" method="POST">
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-6">
        ...
        <div class="flex items-center gap-2 w-full sm:w-auto">
            <a href="{{ route('clientes.show', $cliente->cliente_dni) }}" class="px-4 py-2 rounded-lg text-sm font-medium transition-all min-h-[44px] flex items-center justify-center flex-1 sm:flex-none"
