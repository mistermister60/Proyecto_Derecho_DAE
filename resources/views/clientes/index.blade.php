...
<div x-data="{ 
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <a href="{{ route('clientes.show', $cliente->cliente_dni) }}" 
           class="cliente-card rounded-xl p-4 transition-all"
           x-show="shouldShow('{{ addslashes($cliente->cliente_nombre) }}', '{{ addslashes($cliente->cliente_apellido) }}', '{{ $cliente->cliente_dni }}', '{{ $cliente->cliente_telefono }}', '{{ $cliente->cliente_estado }}')"
