...
<div x-data="{ 
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-5">
        <h1 class="text-xl font-bold" style="color: #111827;">Clientes</h1>
         <a href="{{ route('clientes.create') }}" class="flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-medium transition-all bg-blue-600 text-white hover:bg-blue-700 min-h-[44px]">
